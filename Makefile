...
LDFLAGS:= -L libtorch/lib -ltorch -ltorch_cpu -lc10 -lX11

CFLAGS:= -pedantic -Wall -Wextra -Wno-missing-field-initializers -std=c++17 -I include -I libtorch/include -I libtorch/include/torch/csrc/api/include -I X11/include
